...
void TCS34727_GET_RGB(RGB_COLOR_HANDLE_t* RGB_COLOR_Instance){
	...
	*/ 
	...
	RGB_COLOR_Instance->R = (uint8_t)((RGB_COLOR_Instance->R_RAW / (float)RGB_COLOR_Instance->C_RAW) * 255.0);
	RGB_COLOR_Instance->G = (uint8_t)((RGB_COLOR_Instance->G_RAW / (float)RGB_COLOR_Instance->C_RAW) * 255.0);
	RGB_COLOR_Instance->B = (uint8_t)((RGB_COLOR_Instance->B_RAW / (float)RGB_COLOR_Instance->C_RAW) * 255.0);
